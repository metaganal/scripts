...
# high quality sequence : remove reads containing N
...
# print out the usage command if the user type the wrong input
if len(argvs) != 2:
    print("usage : python hq_N.filter.py fastq_raw_reads_file")
    sys.exit(0)
